...
export const getDescriptionFile = (
  ...
  const projectInfo = url ? `[project](https://gigamaster.github.io/livecodes/?x=${url})` : 'project';

  return {
    [safeName(config.title) + '.md']: {
      content: `# ${config.title}\nA ${projectInfo} created ${userInfo} on [LiveCodes](https://gigamaster.github.io/livecodes).`,
    },
  };
};
