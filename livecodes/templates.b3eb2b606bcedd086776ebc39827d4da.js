...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var h={name:"bootstrap",title:window.deps.translateString("templates.starter.bootstrap","Bootstrap Starter"),thumbnail:"assets/templates/bootstrap.svg",activeEditor:"markup",markup:{language:"html",content:`
...
`.trimStart()},script:{language:"javascript",content:""},stylesheets:["{{ __CDN_URL__ }}bootstrap@5.3.0/dist/css/bootstrap.min.css"],scripts:["{{ __CDN_URL__ }}bootstrap@5.3.0/dist/js/bootstrap.bundle.min.js"],cssPreset:"",imports:{},types:{}};var b={name:"coffeescript",title:window.deps.translateString("templates.starter.coffeescript","CoffeeScript Starter"),thumbnail:"assets/templates/coffeescript.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var q={name:"react",title:window.deps.translateString("templates.starter.react","React Starter"),thumbnail:"assets/templates/react.svg",activeEditor:"script",markup:{language:"html",content:""},style:{language:"css",content:`
.container,
.container button {
  background: #fff;
  border-radius: 0.5em;
...
Js.log("Hello, Reason!");
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var $={name:"ocaml",title:window.deps.translateString("templates.starter.ocaml","Ocaml Starter"),thumbnail:"assets/templates/ocaml.svg",activeEditor:"script",markup:{language:"html",content:`<div id="app">Loading...</div>
`},style:{language:"css",content:`
.container,
.container button {
  background: #fff;
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var P={name:"riot",title:window.deps.translateString("templates.starter.riot","Riot.js Starter"),thumbnail:"assets/templates/riot.svg",activeEditor:"script",markup:{language:"html",content:`
...
`.trimStart()},stylesheets:[],scripts:[],cssPreset:"",imports:{},types:{}};var R={name:"ruby",title:window.deps.translateString("templates.starter.ruby","Ruby Starter"),thumbnail:"assets/templates/ruby.svg",activeEditor:"script",markup:{language:"html",content:`
<div class="container">
  <h1>Hello, <span id="title">World</span>!</h1>
...
`.trimStart()},tools:{enabled:"all",active:"tests",status:"open"}};var ot={name:"jest-react",title:window.deps.translateString("templates.starter.jest-react","Jest/React Starter"),thumbnail:"assets/templates/jest.svg",activeEditor:"script",autotest:!0,markup:{language:"html",content:""},style:{language:"css",content:`
.container,
.container button {
  background: #fff;
  border-radius: 0.5em;
...
`.trimStart()},script:{language:"r",content:`
head(iris)
...
`.trimStart()}};var wt={name:"d3",title:"D3 Starter",thumbnail:"assets/templates/d3.svg",activeEditor:"script",markup:{language:"html",content:`
    <div class="container">
      <h3>D3.js</h3>
...
svg
  ...
  .attr("y", (d, i) => i * 50 + 10)
  .attr("x", 10);
`.trimStart()}};var Js=[g,m,p,d,u,f,h,it,tt,mt,b,V,F,Z,wt,et,lt,xt,v,st,nt,ot,rt,y,J,x,gt,S,w,dt,X,L,k,$,_,St,j,ut,ft,T,Q,U,C,at,E,q,B,M,P,R,pt,H,N,Y,D,O,W,K,ct,A,I,z,G];export{Js as starterTemplates};
